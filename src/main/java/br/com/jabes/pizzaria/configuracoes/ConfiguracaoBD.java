...
@EnableJpaRepositories(basePackages = "br.com.jabes.pizzaria.modelo.repositorios")
public class ConfiguracaoBD {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws Exception {
		...
		entityManagerFactoryBean.setPackagesToScan("br.com.jabes.pizzaria.modelo.entidades");
